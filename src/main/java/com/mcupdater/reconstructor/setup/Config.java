...
public class Config {
    ...
    static {
        ...
        WHITELIST = COMMON_BUILDER.comment("Package names of mods that should be repaired by the Reconstructor.").defineList("whitelist", Arrays.asList("slimeknights.tconstruct","landmaster.plustic.tools","c4.conarm.common.items.armor"), (Object o) -> true);
        COMMON_BUILDER.pop();
